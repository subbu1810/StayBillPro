...
export default function SuppliersScreen({ defaultTab }) {
    ...
    const handleDownloadReceipt = (payment) => {
        ...
        doc.text("PAYMENT RECEIPT", 105, 17, null, null, "center");
        ...
        autoTable(doc, {
            body: [
                ['Receipt No:', payment.reference_no || 'N/A'],
                ['Date:', new Date(payment.payment_date).toLocaleDateString()],
                ['Paid To:', payment.supplier_name],
                ['Amount:', `Rs. ${Number(payment.amount).toLocaleString()}`],
                ['Payment Mode:', payment.payment_method],
                ['Notes:', payment.notes || '-']
            ],
            theme: 'grid',
            styles: { fontSize: 11, cellPadding: 8, lineColor: [226, 232, 240] },
            columnStyles: {
        ...
        doc.text("Generated by StayBillPro", 105, finalY + 26, null, null, "center");
